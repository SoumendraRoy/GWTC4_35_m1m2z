...
population_params = [:R, :alphalm1, :alphamm1, :alphahm1, :mbreakf1, :mbreaks1, :rlm2, :alphalm2, :rhm2, :alphahm2, :mu_peak2, :sigma_peak2, :beta, :lambda, :zp, :kappa, :alpha_chi_eff, :beta_chi_eff, :Neff_sel]
cosmo_params = [:h, :Ω_M]
