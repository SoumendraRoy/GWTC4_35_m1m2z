...
function make_log_dNdm1dqdVdt(alphalm1, alphamm1, alphahm1, mbreakf1, mbreaks1, alphalm2, alphamm2, alphahm2, mbreakf2, mbreaks2, beta, lambda, zp, kappa; mgrid=collect(10:0.25:100), mnorm=35.0, qnorm=1.0, znorm=0.0)
    log_dNdm_total1 = make_combined_log_dNdm1(alphalm1, alphamm1, alphahm1, mbreakf1, mbreaks1)
    log_dNdm_total2 = make_combined_log_dNdm1(alphalm2, alphamm2, alphahm2, mbreakf2, mbreaks2)
...
@model function pop_model_samples(evt_samples, log_prior_wts, sel_samples, log_sel_pdraw, Ndraw, m_grid, zs_interp)
    ...
    mbreakf2 ~ Uniform(20, 25)
    mbreaks2 ~ Uniform(30, 40)
    ...
    # Pop density
    log_dNdm1dqdVdt = make_log_dNdm1dqdVdt(alphalm1, alphamm1, alphahm1, mbreakf1, mbreaks1, alphalm2, alphamm2, alphahm2, mbreakf2, mbreaks2, beta, lambda, zp, kappa; mgrid=m_grid)
