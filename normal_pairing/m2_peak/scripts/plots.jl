...
population_params = [:R, :alphalm1, :alphamm1, :alphahm1, :mbreakf1, :mbreaks1, :rlm2, :alphalm2, :rhm2, :alphahm2, :mu_peak2, :sigma_peak2, :alpharight2, :mturn_right2, :mu, :sigma, :lambda, :zp, :kappa, :Neff_sel]
cosmo_params = [:h, :Ω_M]
