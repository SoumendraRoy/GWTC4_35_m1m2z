...
function make_log_dNdm1dqdVdt(alphalm1, alphamm1, alphahm1, mbreakf1, mbreaks1, log_rlm2, alphalm2, log_rhm2, alphahm2, mu_peak2, sigma_peak2, k32, alpharight2, mturn_right2, mu, sigma, f, beta, lambda, zp, kappa; mgrid=collect(10:0.25:100), mnorm=35.0, qnorm=1.0, znorm=0.0)
...
@model function pop_model_samples(evt_samples, log_prior_wts, sel_samples, log_sel_pdraw, Ndraw, m_grid, zs_interp)
    ...
    # Pop density
    log_dNdm1dqdVdt = make_log_dNdm1dqdVdt(alphalm1, alphamm1, alphahm1, mbreakf1, mbreaks1, log_rlm2, alphalm2, log_rhm2, alphahm2, mu_peak2, sigma_peak2, k32, alpharight2, mturn_right2, mu, sigma, f, beta, lambda, zp, kappa; mgrid=m_grid)
